...
const Command: ParentComponent<ComponentProps<"div">> = (props) => {
	...
	return (
		...
		>
			{/* biome-ignore lint/a11y/noStaticElementInteractions: arrow-key handler bubbling up from the focused CommandInput; the wrapper itself is never focused. */}
			<div
				data-slot="command"
				class={cn(
...
> = (props) => {
	...
	return (
		<Show when={isVisible()}>
			{/* biome-ignore lint/a11y/noStaticElementInteractions: active-descendant pattern; focus stays in CommandInput and the highlighted item activates via Enter there. */}
			<div
