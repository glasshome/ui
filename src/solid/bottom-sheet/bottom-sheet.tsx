...
const BottomSheetContent: ParentComponent<BottomSheetContentProps> = (props) => {
  ...
  return (
    <div
      ...
      class={cn(
        "bs-content",
        "fixed inset-x-0 bottom-0 flex max-h-[85dvh] flex-col rounded-t-xl border-x border-t border-border bg-background shadow-lg outline-none",
...
const BottomSheetHandle: Component<ComponentProps<"div">> = (props) => {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      class={cn(
        "flex h-8 w-full shrink-0 select-none items-center justify-center touch-none",
        local.class,
      )}
      {...rest}
    >
